...
func TestNodeStageVolume(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedErr:          nil,
			expectedMountpoints:  []mount.MountPoint{{Device: "1.1.1.1@tcp:/lustrefs", Path: targetTest, Type: "lustre", Opts: []string{"noatime", "flock", "unique_fsid"}}},
		...
		},
		{
			...
			expectedErr:          nil,
			expectedMountpoints:  []mount.MountPoint{{Device: "1.1.1.1@tcp:/lustrefs", Path: targetTest, Type: "lustre", Opts: []string{"noatime", "flock", "ro", "unique_fsid"}}},
			expectedMountActions: []mount.FakeAction{{Action: "mount", Target: targetTest, Source: "1.1.1.1@tcp:/lustrefs", FSType: "lustre"}},
		},
		{
			desc: "Error creating directory",
