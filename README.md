...
Starting with v0.4.0, the driver ships separate images per node OS: `-jammy` (Ubuntu 22.04) and `-noble` (Ubuntu 24.04). An `-azurelinux3` (Azure Linux 3) image is available starting with v0.99.0. See [deploy/README-distribution-specific.md](deploy/README-distribution-specific.md) for details.

The addition of native sidecar containers (init containers with `restartPolicy: Always`) since v0.4.0 now forces a requirement on Kubernetes 1.29+ which enables that feature by default.

| Driver version | Image | Supported k8s version | Lustre client version |
| -------------- | ----- | --------------------- | --------------------- |
| main branch | mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-jammy<br>mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-noble<br>mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-azurelinux3 | 1.29+ | 2.15.8 (jammy)<br>2.17.0 (noble)<br>2.17.0 (azurelinux3) |
...
| v0.99.0 | mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-jammy<br>mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-noble<br>mcr.microsoft.com/oss/v2/kubernetes-csi/azurelustre-csi:v0.99.0-azurelinux3 | 1.29+ | 2.15.8 (jammy)<br>2.17.0 (noble)<br>2.17.0 (azurelinux3) |
